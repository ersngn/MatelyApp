...
public static class TransactionMessageConstant
{
    ...
    public const string ProfileNotFount = "The profile was not exist.";
    public const string ProfileNotCreated = "The profile was not created.";
    public const string ProfileNotUpdated = "The profile was not updated.";
    public const string ProfilesNotFoundByDistance = "Profiles was not found by user location.";
